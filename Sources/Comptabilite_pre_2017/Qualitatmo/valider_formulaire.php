...
{
	nomFiche = document.getElementById('nom_fiche').value;

	//window.parent.opener.location.reload();
	window.parent.opener.location.href = "editer_fiche.php?nom="+nomFiche ;
	window.close();
}
</script> 
</head>
...
echo "<input type=hidden id=nom_fiche value=$nom_fiche>";
