...
#	}
	...
	echo "<td colspan=3>";
		...
		echo "<td width=37%>";	
			echo "<table border=0 width=100% >";		
				// On prend, dans Periodes, tout ce qui a un ID axe1 correspondant à l' ID axe1 de la table Axe1 contenant les codes axe1 = 5xxx (99xx = congés). 
		...
		echo "<td width=37%>";	
			echo "<table border=0 width=100%>";
				// On prend, dans Periodes, tout ce qui a un ID axe2 correspondant à l' ID axe2 de la table Axe2 contenant les codes axe2 = 5xxx (99xx = congés). 
		...
		echo "<td>";	
			echo "<table border=0 width=100%>";
				// On prend, dans Periodes, tout ce qui a un ID axe2 correspondant à l' ID axe2 de la table Axe2 contenant les codes axe2 = 99xx (99xx = congés). 
	...
	echo "<td colspan=3>";
		...
		echo "<td width=37%>";	
			echo "<table border=0 width=100% >";		
				// On prend, dans Periodes, tout ce qui a un ID axe1 correspondant à l' ID axe1 de la table Axe1 contenant les codes axe1 = 99xx (99xx = congés). 
