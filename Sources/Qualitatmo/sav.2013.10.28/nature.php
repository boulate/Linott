...
<!-- SECTION COMPTE RENDU -->
	<table border=1 width=100%>
		<tr>
			<td><h4>Mesurage :</h4></td>
			<td><h4>Infrastructure :</h4></td>
			<td><h4>Etude :</h4></td>
			<td><h4>Modelisation :</h4></td>
		</tr>
		...
		<tr>
			<td>
				<p>
					...
					?>
						<input type="checkbox" name="nature_cochee[]" value="<?php echo $id_nature ?>" id="<?php echo $nom_nature ?>">
					...
					<form method="post" action="ajouter_nature_mesurage.php" enctype="multipart/form-data">
			...
			<td>
				<p>
					...
					<form method="post" action="ajouter_nature_infrastructure.php" enctype="multipart/form-data">
			...
			<td>
				<p>
					...
					<form method="post" action="ajouter_nature_etude.php" enctype="multipart/form-data">
			...
			<td>
				<p>
					...
					<form method="post" action="ajouter_nature_modelisation.php" enctype="multipart/form-data">
	...
	<tr>
			<td><h4>Secretariat/Comptabilite :</h4></td>
			<td><h4>Qualite :</h4></td>
			<td><h4>Information/Alerte :</h4></td>
	...
	<tr>
			...
			<td>
				<p>
					...
					<form method="post" action="ajouter_nature_secretariat_comptabilite.php" enctype="multipart/form-data">
			...
			<td>
					...
					<form method="post" action="ajouter_nature_qualite.php" enctype="multipart/form-data">
			...
			<td>
					...
					<form method="post" action="ajouter_nature_information_alerte.php" enctype="multipart/form-data">
			...
			<td>
					...
					<form method="post" action="ajouter_nature_direction.php" enctype="multipart/form-data">
