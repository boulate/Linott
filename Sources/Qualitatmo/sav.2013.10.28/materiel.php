...
<table width=100% border=0>
	<tr>
		...
		<td width=28%>
			...
			<form method="post" action="ajouter_marque.php" enctype="multipart/form-data">
	...
	<tr>	
		...
		<td>
			...
			<form method="post" action="ajouter_site.php" enctype="multipart/form-data">
		...
		<td>
			...
			<form method="post" action="ajouter_type_materiel.php" enctype="multipart/form-data">
	...
	<tr>
		...
		<td>
			...
			<form method="post" action="ajouter_materiel.php" enctype="multipart/form-data">
		...
		<td>
			<!-- Formulaire pour ajouter un element a materiel -->
			<form method="post" action="ajouter_num_serie.php" enctype="multipart/form-data">
