...
//	echo checkInput($login, "login");
			...
			// On va chercher l'idAxe1 du code 99 ( == congés et autre absences selon le README)
			$requete_import_idAxe1 = "SELECT `idAxe1` FROM Axe1 WHERE codeAxe1 = '99'";
...
///////////////////// Si on doit supprimer un congé ////////////////////////
			...
			{
				$totalHoraire = 0;
				// On va chercher la periodeJournee du code 99 ( == congés et autre absences selon le README)
