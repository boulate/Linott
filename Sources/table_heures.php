		...
		while($periode<=$nombre_lignes_total/2)
			...
			?>
				...
				<td align=center id=deA>
						...
						<input type="text" id="choix_axe1_periode<?php echo "$periode"?>" name="choix_axe1_periode<?php echo "$periode"?>"  value="Choisir axe 1" onKeyUp=javascript:affichage_popup('axe1','<?php echo "$periode"?>','popup_axe1_periodes'); onClick=javascript:affichage_popup('axe1','<?php echo "$periode"?>','popup_axe1_periodes') readonly> 
						...
						<input type="text" id="choix_axe2_periode<?php echo "$periode"?>" name="choix_axe2_periode<?php echo "$periode"?>"  value="Choisir axe 2" onKeyUp=javascript:affichage_popup('axe2','<?php echo "$periode"?>','popup_axe2_periodes'); onClick=javascript:affichage_popup('axe2','<?php echo "$periode"?>','popup_axe2_periodes') readonly> 
