...
require("verifier_input_php.php");
	...
	$activerSections		=	$_GET['activerSections'];
	...
	$filtrerChoixAxes = $_GET['filtrerChoixAxes'];
...
if (checkInput($activerSections, "caseACocher") != "ok")
{
	echo checkInput($activerSections, "caseACocher");
	exit;
}
...
if (checkInput($filtrerChoixAxes, "caseACocher") != "ok")
{
	echo checkInput($filtrerChoixAxes, "caseACocher");
	exit;
}
			...
			$requete_modification = "UPDATE Configuration SET valeur = $activerSections WHERE nom like 'activerSections' ";
			//echo "$requete_modification";
			try
			{
				$reponse_modification = $bdd->query($requete_modification) or die('Erreur SQL !<br>' .$requete_modification. '<br>'. mysql_error());
			...
			$requete_modification = "UPDATE Configuration SET valeur = '$filtrerChoixAxes' WHERE nom like 'filtrer_choix_axes' ";
			//echo "$requete_modification";
			try
			{
				$reponse_modification = $bdd->query($requete_modification) or die('Erreur SQL !<br>' .$requete_modification. '<br>'. mysql_error());
