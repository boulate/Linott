...
function checkInput($aVerif, $type)
{
	...
	elseif ($type == "Axe2")
	{
		#$ExpressionReguliere = "(^[0-9][0-9][0-9][0-9]$)"; # Pre 2017
		$ExpressionReguliere = "(^[0-9]{4}.?.?$)";
	}
	elseif ($type == "Axe3")
	{
...
//		Teste si la chaine de caractère rentre dans le format de l’expression régulière
	...
	else
	{
		...
		if ($type == "Axe2")
		{
			return "Le format de l'axe 2 doit contenir de 4 à 6 caractères et doit commencer par 4 chiffres.";
		}
		if ($type == "Axe3")
		{
		...
		if ($type == "Section")
		{
			return "Le format de section doit contenir 1 ou 2 caractères uniquement.";
		}
		if ($type == "Mois")
		{
...
Exemple pour 30 jours de RTT par ans: \"30.00\" ou \"30\"";
		...
		{
			return "Les codes comptables Axe2 à exclure des totaux doivent être séparés par des virgules (ex: 9901,9904,9906...)";
		}
